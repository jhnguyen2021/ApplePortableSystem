<%@ Page Title="Order" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="EditOrder.aspx.vb" Inherits="EditOrder" %>
...
<link rel="stylesheet" type="text/css" href="Scripts/jquery.fancybox.css" />
   <script src="https://polyfill.io/v3/polyfill.min.js?features=default"></script>
     ...
     <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
         <script type="text/javascript">
             ...
             function fillInAddress() {
                 ...
                 for (var _i = 0, _a = place.address_components; _i < _a.length; _i++) {
                     ...
                     switch (componentType) {
                         ...
                         case "country":
                             document.querySelector("#MainContent_cbSCountry").value =
                                 component.long_name;
                             break;
                     }
                 }
             ...
             function FillBilling() {
                 ...
                 if (document.getElementById("<%=CheckBox1.ClientID %>").checked == true) {
                    ...
                    //phone.set_value(document.getElementById("<%=tbSOnsitePhone.ClientID %>").value);
                     ...
                     $telerik.$('#<%=tbPAddress1.ClientID %>').val(document.getElementById("<%=tbSAddress1.ClientID %>").value)
            ...
            if (country._text == 'UNITED STATES' ) {
               ...
               <%-- document.getElementById("<%= tbPRegion.ClientID%>").style.display = 'inline-block';
                document.getElementById("<%= cbPState.ClientID%>").style.display = 'none';
                document.getElementById("<%=tbPRegion.ClientID %>").value = document.getElementById("<%=tbSRegion.ClientID %>").value--%>
                $("#tbSRegion").val();
            }
        ...
        if (document.getElementById("<%=CheckBox1.ClientID %>").checked == false) {
            ...
            document.getElementById("<%=tbPRegion.ClientID %>").value = ' '
            ...
            //$(".pickup").show()
             ...
             function OnShippingClientSelectedIndexChanged(sender, eventArgs) {
                ...
                <%-- if (item.get_text() == 'UNITED STATES') {
                     document.getElementById("<%= tbSRegion.ClientID%>").style.display = 'none';
                     document.getElementById("<%=CheckBox1.ClientID%>").style.display = 'inline-block';
                 } else {
                     document.getElementById("<%= tbSRegion.ClientID%>").style.display = 'inline-block';
                     document.getElementById("<%= cbSState.ClientID%>").style.display = 'none';
                 }--%>
             ...
             function OnPickupClientSelectedIndexChanged(sender, eventArgs) {
                ...
                <%-- if (item.get_text() == 'UNITED STATES') {
                     document.getElementById("<%= tbPRegion.ClientID%>").style.display = 'none';
                     document.getElementById("<%= cbPState.ClientID%>").style.display = 'inline-block';
                 } else {
                     document.getElementById("<%= tbPRegion.ClientID%>").style.display = 'inline-block';
                     document.getElementById("<%= cbPState.ClientID%>").style.display = 'none';
                 }--%>
    ...
    ErrorMessage="Please, enter valid e-mail address." ValidationExpression="^[\w\.\-]+@[a-zA-Z0-9\-]+(\.[a-zA-Z0-9\-]{1,})*(\.[a-zA-Z]{2,3}){1,2}$" ForeColor="Red" ControlToValidate="tbContactEmail" ValidationGroup="ValidateFields">*</asp:RegularExpressionValidator></td></tr>
        <tr><td>Apple Contact Phone #:</td><td><telerik:RadNumericTextBox EmptyMessage="No dashes or parenthesis" ID="tbContactPhone" runat="server" width="250px" NumberFormat-DecimalDigits="0">
        ...
        <tr><td>Event End Date:</td><td>
            ...
            <asp:CompareValidator ID="CompareValidator1" runat="server" ForeColor="Red" Display="Dynamic" Operator="GreaterThanEqual" ControlToValidate="tbPickupDate" ControlToCompare="tbArrivalDate"
ValidationGroup="ValidateFields"  ErrorMessage="The Pickup Date must be on or after the Start Date" Enabled="true">*</asp:CompareValidator>
                                    </td></tr>
        ...
        <tr>
            ...
            <td colspan="2"><telerik:RadEditor MaxTextLength="1000"  ID="tbNotes" runat="server" OnClientLoad="OnClientLoad"
     ...
     <table class="entry" style="display:none;">
        ...
        <tr><td style="white-space: nowrap;width:250px;vertical-align:top;">Attach Document(s):<div style="width:250px"></div></td><td ><telerik:RadAsyncUpload ID="AsyncUpload1" runat="server" 
                    ...
                    <asp:Label ID="Uploaded" runat="server"></asp:Label></td></tr>
    </table>
    ...
    ErrorMessage="Please, enter valid e-mail address." ValidationExpression="^[\w\.\-]+@[a-zA-Z0-9\-]+(\.[a-zA-Z0-9\-]{1,})*(\.[a-zA-Z]{2,3}){1,2}$" ForeColor="Red" ControlToValidate="tbSOnsiteEmail" ValidationGroup="ValidateFields">*</asp:RegularExpressionValidator>
             ...
             <tr>
                ...
                <td>
                    <telerik:RadNumericTextBox EmptyMessage="No dashes or parenthesis" ID="tbSOnsitePhone" Runat="server"   NumberFormat-DecimalDigits="0" width="250px">
            <NegativeStyle Resize="None" />
            <NumberFormat DecimalDigits="0" GroupSeparator="" ZeroPattern="n" />
            <EmptyMessageStyle Resize="None" />
            <ReadOnlyStyle Resize="None" />
            ...
            <HoveredStyle Resize="None" />
            <EnabledStyle Resize="None" />
                    </telerik:RadNumericTextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" 
                        ErrorMessage="Ship to Onsite Contact Phone #" ControlToValidate="tbSOnsitePhone" ForeColor="Red" ValidationGroup="ValidateFields">*</asp:RequiredFieldValidator>
                </td>
            </tr>
          ...
          required="required" />
            ...
            <%--<tr>
                <td style="width:250px">
                    Country:</td>
                <td>
                    <telerik:RadComboBox ID="cbSCountry" Runat="server" AutoCompleteSeparator="" MarkFirstMatch="true" OnClientSelectedIndexChanged="OnShippingClientSelectedIndexChanged" width="250px">
                        <Items>
        ...
        <tr>
          ...
          required="required" />
            ...
            <tr>
                ...
                <td><telerik:RadDatePicker ID="tbArrivalDate" runat="server" Calendar-ShowRowHeaders="false" Width="250px"></telerik:RadDatePicker>
    ...
    ErrorMessage="Please, enter valid e-mail address." ValidationExpression="^[\w\.\-]+@[a-zA-Z0-9\-]+(\.[a-zA-Z0-9\-]{1,})*(\.[a-zA-Z]{2,3}){1,2}$" ForeColor="Red" ControlToValidate="tbPOnsiteEmail" ValidationGroup="ValidateFields" Enabled="false">*</asp:RegularExpressionValidator>
        ...
        <tr>
          ...
          <td>
                            ...
                            </telerik:RadTextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" 
                        ErrorMessage="Pickup State" ControlToValidate="cbPState" InitialValue="Select..." ForeColor="Red" ValidationGroup="ValidateFields" Enabled="false">*</asp:RequiredFieldValidator>
                        </td> 
         </tr>
        <tr>
          <td>ZIP/Postal Code:</td>
   ...
   <telerik:RadComboBoxItem Value="Zimbabwe" Text="Zimbabwe" />
    ...
    <div class="results">
        ...
        <telerik:RadGrid ID="Grid1" runat="server" AutoGenerateColumns="False" EnableViewState="true" GridLines="None">
                        <MasterTableView AllowSorting="True" ClientDataKeyNames="pkInventoryID" DataKeyNames="pkInventoryID, Picture, PartNum" >
                            <RowIndicatorColumn>
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn DataField="Picture" HeaderText="Image" 
                                    UniqueName="Picture">
                                    <ItemTemplate>
                                         <div class="imgcontainer"><img src='inventory/<%# (Eval("Picture"))%>' height='80' alt='<%# (Eval("Picture"))%>' class="fancybox"/></div>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridBoundColumn DataField="Type" HeaderText="Type" UniqueName="Type">
                                </telerik:GridBoundColumn>
                                  <telerik:GridBoundColumn DataField="deptdesc" HeaderText="Department" UniqueName="Department" AllowSorting="true" SortExpression="deptdesc">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn DataField="Available" HeaderText="Inventory Amount" 
     ...
     <div id="nav" style="right:5px; top:0px; position:fixed;background-color:White;width:250px;" >
    <telerik:RadAjaxPanel ID="RadAjaxPanel6" runat="server" HorizontalAlign="NotSet" width="100%" RestoreOriginalRenderDelegate="false">
                    ...
                    <telerik:RadGrid ID="orderGrid" runat="server" AutoGenerateColumns="False" OnItemCreated="orderGrid_ItemCreated"
                        ...
                        <MasterTableView AllowSorting="True" ClientDataKeyNames="pkInventoryID" DataKeyNames="pkInventoryID, Quantity, PartNum, Picture" >
                            <RowIndicatorColumn>
                            ...
                            <Columns>
                                 <telerik:GridTemplateColumn HeaderText="Qty" UniqueName="Qty">
                                    ...
                                    <ItemTemplate>
                                        <asp:DropDownList ID="myQty"  DataField="Quantity" runat="server" style="margin-left:-6px;" Font-Size="X-Small" AutoPostBack="true" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridBoundColumn  DataField="PartNum" HeaderText=""  UniqueName="PartNum" > <HeaderStyle Width="35px" /></telerik:GridBoundColumn>

                                <telerik:GridTemplateColumn DataField="pkInventoryID" HeaderText="Image" UniqueName="Picture">
                                    <ItemTemplate>
                                        <div class="imgcontainer"><img src='inventory/<%# (Eval("picture"))%>' height='80' alt='<%# (Eval("pkInventoryID"))%>' class="fancybox"/></div>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
         ...
         <div style="background-color:#ddd;font-size:14px;text-align:center;" id="nav1" runat="server">Inventory Options Below</div>
     </div>
...
<asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none">
    ...
    <telerik:RadButton ID="RadButton2" runat="server" Text="Update Order" Height="40px" style="margin-left:50px;margin-top:50px;margin-bottom:50px;" RenderMode="Lightweight"  ValidationGroup="ValidateFields"  OnClientClick="validateOrderQuantity()"></telerik:RadButton>
    <telerik:RadButton ID="RadButton3" runat="server" Text="Save" Height="40px" style="margin-left:50px;margin-top:50px;margin-bottom:50px;" RenderMode="Lightweight"  Visible="false"></telerik:RadButton>
