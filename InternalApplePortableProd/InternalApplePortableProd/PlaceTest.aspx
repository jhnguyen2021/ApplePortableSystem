<%@ Page Title="Place Order" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="PlaceTest.aspx.vb" Inherits="PlaceTest" %>
...
ValidationGroup="ValidateFields"  ErrorMessage="The Pickup Date must be on or after the Start Date" Enabled="true">*</asp:CompareValidator>
        ...
        <tr>
            ...
            <td colspan="2"><telerik:RadEditor MaxTextLength="1000"  ID="tbNotes" runat="server" OnClientLoad="OnClientLoad" StripFormattingOptions="ConvertWordLists, MSWordNoMargins"
   ...
   <telerik:RadComboBoxItem Value="Zimbabwe" Text="Zimbabwe" />
    ...
    <telerik:RadButton ID="RadButton2" runat="server" Text="Select Inventory" Height="40px" style="margin-left:100px;margin-top:50px;margin-bottom:50px;" RenderMode="Lightweight"  ValidationGroup="ValidateFields"  OnClientClick="validateOrderQuantity()"></telerik:RadButton>
