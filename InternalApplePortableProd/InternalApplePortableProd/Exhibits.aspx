<%@ Page Title="Inventory" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Exhibits.aspx.vb" Inherits="Exhibits" ValidateRequest="false"%>
...
<CommandItemSettings ShowExportToPdfButton="false" ShowExportToCsvButton="true" ShowExportToExcelButton="false" ShowExportToWordButton="false" ></CommandItemSettings>
    ...
    <Columns>
     ...
     <telerik:RadComboBox id="ccInventory" runat="server" Width="177px" AllowCustomText="true" MarkFirstMatch="true" />
        ...
        <telerik:GridBoundColumn HeaderText="Description" UniqueName="Description" AllowSorting="true" SortExpression="Description" DataField="Description">
             <HeaderStyle />
...
<telerik:GridBoundColumn HeaderText="Part#" UniqueName="PartNum" DataField="PartNum" >
  ...
  <%--       <telerik:GridTemplateColumn UniqueName="Available" HeaderText="Total Inventory Amount" >
            <ItemTemplate>
  <%# If(Eval("TotalInventory") <> 0, Eval("TotalInventory"), "Out of Stock") %> 
        ...
        <telerik:GridTemplateColumn UniqueName="QuantityAvailableByDate" HeaderText="On Hand Inventory" >
            <ItemTemplate>
...
<%--        <telerik:GridNumericColumn HeaderText="Total Inventory Amount" UniqueName="Total" DataField="Total" FilterControlWidth="40px" HeaderStyle-Width="40px" ReadOnly="true"></telerik:GridNumericColumn>--%>
        ...
        <telerik:GridTemplateColumn UniqueName="Type" HeaderText="Type" SortExpression="Type" DataField="Type" GroupByExpression="Type Group By Type" >
            <ItemTemplate>
                <%# Eval("Type")%>           
            </ItemTemplate>
            <edititemtemplate>
